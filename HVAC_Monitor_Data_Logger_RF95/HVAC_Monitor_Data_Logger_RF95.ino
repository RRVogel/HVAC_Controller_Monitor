...
//  wdt_reset();
  ...
  //determine if duct should be on
...
/*      Serial.println("Received Data");
      Serial.println("ODtemp\tAmps\tsysState\tRHcontrol\tRHduct\tfState\tPSI");
      Serial.print(ControlData.ODtemp);
      Serial.print("\t");
      Serial.print(ControlData.Amps);
      Serial.print("\t");
      Serial.print(ControlData.systemState);
      Serial.print("\t\t");
      Serial.print(ControlData.humidControl);
      Serial.print("\t\t");
      Serial.print(ControlData.duct_RH);
      Serial.print("\t");
      Serial.print(fanState);
      Serial.print("\t");
      Serial.println(ControlData.pressure);*/
    }
  }
}
//=============
